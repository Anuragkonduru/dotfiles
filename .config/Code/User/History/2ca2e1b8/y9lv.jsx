...
const EducationItems = (props) => {
  return (
    <div className="w-11/12 overflow-auto shadow-md transition-transform ease-in-out hover:scale-110 hover:bg-white dark:ring-white/10 hover:dark:bg-gray-800 sm:rounded-md">
