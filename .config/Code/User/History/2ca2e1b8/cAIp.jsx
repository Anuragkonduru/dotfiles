...
const EducationItems = (props) => {
  return (
    <div className=" lg:w-2/3 xl:w-2/4 overflow-auto shadow-md ring-1 ring-black/5 transition-transform ease-in-out hover:scale-110 hover:bg-white dark:ring-white/10 hover:dark:bg-gray-800 sm:rounded-md">
