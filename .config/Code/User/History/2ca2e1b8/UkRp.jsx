...
const EducationItems = (props) => {
  return (
    <div className="w-11/12 overflow-auto shadow-md ring-1 ring-black/5 transition-transform ease-in-out hover:scale-110 hover:bg-white dark:ring-white/10 hover:dark:bg-gray-800 sm:rounded-md">
            ...
            <div className="px-4 py-4 sm:px-6">
              <div className="flex items-center justify-between">
                ...
                <div className="ml-2 flex flex-shrink-0">
                  <p className="inline-flex rounded-fullpx-2 text-xs font-semibold leading-5 "></p>
                </div>
              </div>
