...
keymap("<leader>A", function() require("harpoon"):list():append() end, desc = "harpoon file",)



    	  keymap("<leader>a", function() local harpoon = require("harpoon") harpoon.ui:toggle_quick_menu(harpoon:list()) end, desc : "harpoon quick menu")
    	  keymap("<leader>1", function() require("harpoon"):list():select(1) end, desc = "harpoon to file 1")
    	  keymap("<leader>2", function() require("harpoon"):list():select(2) end, desc = "harpoon to file 2")
    	  keymap("<leader>3", function() require("harpoon"):list():select(3) end, desc = "harpoon to file 3")
    	  keymap("<leader>4", function() require("harpoon"):list():select(4) end, desc = "harpoon to file 4")
    	  keymap("<leader>5", function() require("harpoon"):list():select(5) end, desc = "harpoon to file 5")
