...
--Harpoon
keymap("<leader>A", function() require("harpoon"):list():append() end)
keymap("<leader>a", function() local harpoon = require("harpoon") harpoon.ui:toggle_quick_menu(harpoon:list()) end)
keymap("<leader>1", function() require("harpoon"):list():select(1) end)
keymap("<leader>2", function() require("harpoon"):list():select(2) end)
keymap("<leader>3", function() require("harpoon"):list():select(3) end)
keymap("<leader>4", function() require("harpoon"):list():select(4) end)
keymap("<leader>5", function() require("harpoon"):list():select(5) end)
