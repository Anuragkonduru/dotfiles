...
export class ProductsService {
  ...
  getAllProducts(): Observable<ProductsModel[]> {
    return http.get<ProductsModel[]>(this.API_URL + 'Products/getAllProducts').pipe(map((response: any) => {
      response.map((product: { productId: any; productname: any; description: any; categoryId: any; inventoryId: any; price: any; discountId: any; reviewId: any; createdAt: any; modifiedAt: any; images: any; }) => ({
