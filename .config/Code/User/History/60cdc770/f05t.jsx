...
const Home = () => {
  ...
  return (
    <div
      id="home"
      className="relative isolate flex flex-col md:flex-row items-center justify-center px-1  py-1 align-middle md:h-93 lg:px-8"
    >
      <div>
        {" "}
        <p className="mb-5 mt-10 text-lg  leading-8 text-black dark:text-white sm:text-3xl">
          Hi, I'm{" "}
          <span className="text-dark_violet dark:text-violet mb-2 m-6 leading-8 ">
            {infos.basics.name}
          </span>
        </p>
        <h1 className="md:text-6xl text-4xl font-bold text-gray-900 dark:text-white lg:text-7xl">
          {infos.basics.title}
        </h1>
        ...
        px-4  py-2 text-lg font-semibold uppercase
