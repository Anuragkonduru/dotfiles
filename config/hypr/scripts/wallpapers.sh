...
wallpaper=$(find ~/Pictures/wallpapers/ -type f -name "*.jpg" -o -name "*.png" -o -name "*.gif" | shuf -n 1)
#wallpaper2=$(find ~/Pictures/wallpapers/ -type f -name "*.jpg" -o -name "*.png" -o -name "*.gif" | shuf -n 1)
# ----------------------------------------------------- 
